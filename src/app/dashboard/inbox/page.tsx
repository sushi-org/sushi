              ...
              {detail.escalation_reason &&
                ...
                <div className="shrink-0 border-b border-amber-200 bg-amber-50 px-4 py-3 sm:px-6">
                  <div className="mx-auto flex max-w-2xl items-start gap-2">
                    <svg viewBox="0 0 24 24" className="mt-0.5 h-4 w-4 shrink-0 text-amber-600" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M12 9v4M12 17h.01M10.29 3.86l-8.6 14.86A2 2 0 003.43 21h17.14a2 2 0 001.74-2.98l-8.6-14.86a2 2 0 00-3.42 0z" />
                    </svg>
                    <div>
                      <p className="text-xs font-semibold text-amber-800">Why escalated</p>
                      <p className="mt-0.5 text-sm text-amber-700">{detail.escalation_reason}</p>
                    </div>
                  </div>
                </div>
              )}
                        ...
                        <div className="mt-3 space-y-3">
                          ...
                          {detail.escalation_reason && (
                            <p className="rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700">
                              <span className="font-semibold">AI escalated because:</span>{" "}
                              {detail.escalation_reason}
                            </p>
                          )}
                          <div>
